...
public class MerisProductFile extends ProductFile {
    ...
    public Mask[] createDefaultMasks(String flagDsName) {
        if (getProductType().endsWith("1P")) {
            return new Mask[]{
                    Mask.BandMathsType.create(BITMASKDEF_NAME_COASTLINE, null, getSceneRasterWidth(), getSceneRasterHeight(), "l1_flags.COASTLINE", Color.green, 0.0F),
                    Mask.BandMathsType.create(BITMASKDEF_NAME_LAND, null, getSceneRasterWidth(), getSceneRasterHeight(), "l1_flags.LAND_OCEAN", new Color(51, 153, 0), 0.75F),
                    Mask.BandMathsType.create(BITMASKDEF_NAME_WATER, null,getSceneRasterWidth(), getSceneRasterHeight(),  "NOT l1_flags.LAND_OCEAN", new Color(153, 153, 255),
                                   0.75F),
                    Mask.BandMathsType.create(BITMASKDEF_NAME_COSMETIC, null, getSceneRasterWidth(), getSceneRasterHeight(), "l1_flags.COSMETIC", new Color(204, 153, 255), 0.5F),
                    Mask.BandMathsType.create(BITMASKDEF_NAME_DUPLICATED, null, getSceneRasterWidth(), getSceneRasterHeight(), "l1_flags.DUPLICATED", Color.orange, 0.5F),
                    Mask.BandMathsType.create(BITMASKDEF_NAME_GLINT_RISK, null, getSceneRasterWidth(), getSceneRasterHeight(), "l1_flags.GLINT_RISK", Color.magenta, 0.5F),
                    Mask.BandMathsType.create(BITMASKDEF_NAME_SUSPECT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l1_flags.SUSPECT", new Color(204, 102, 255), 0.5F),
                    Mask.BandMathsType.create(BITMASKDEF_NAME_BRIGHT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l1_flags.BRIGHT", Color.yellow, 0.5F),
                    Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID, null, getSceneRasterWidth(), getSceneRasterHeight(), "l1_flags.INVALID", Color.red, 0.0F)
            };
        } else if (getProductType().endsWith("2P")) {
            if ((getIODDVersion() == IODD_VERSION_6) || (getIODDVersion() == IODD_VERSION_5)) {
                return new Mask[]{
                        // Pixel Types
                        Mask.BandMathsType.create(BITMASKDEF_NAME_COASTLINE, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.COASTLINE", Color.green, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_LAND, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.LAND", new Color(102, 102, 102), 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_CLOUD, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.CLOUD", new Color(255, 255, 255), 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_WATER, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.WATER", new Color(0, 0, 0), 0.0F),

                        // Combined quality flags in red
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_REFLECTANCES, "pixels flagged for invalid reflectances",
                                                  getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.PCD_1_13 AND (l2_flags.LAND OR l2_flags.WATER OR l2_flags.CLOUD)",
                                       Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_WATER_VAPOUR, "pixels flagged for invalid water vapour",
                                                  getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.PCD_14 AND (l2_flags.LAND OR l2_flags.WATER OR l2_flags.CLOUD)",
                                       Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_ALGAL_1, "water pixels flagged for invalid algal1",
                                                  getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.WATER AND l2_flags.PCD_15", Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_ALGAL2_TSM_YS,
                        ...
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_PHOTOSYN_RAD, "water pixels flagged for invalid PAR",
                                                  getSceneRasterWidth(), getSceneRasterHeight(),
                                       "l2_flags.WATER AND l2_flags.PCD_18", Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_TOA_VEG, "land pixels flagged for invalid toa_veg",
                                                  getSceneRasterWidth(), getSceneRasterHeight(),
                                       "l2_flags.LAND AND l2_flags.PCD_15", Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_BOA_VEG, "land pixels flagged for invalid boa_veg",
                                                  getSceneRasterWidth(), getSceneRasterHeight(),
                                       "l2_flags.LAND AND l2_flags.PCD_17", Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_RECT_REFL,
                                       "land pixels flagged for invalid rectified reflectances",
                                       getSceneRasterWidth(), getSceneRasterHeight(),
                                       "l2_flags.LAND AND l2_flags.PCD_16", Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_SURF_PRESS, "land pixels flagged for invalid surf_press",
                                                  getSceneRasterWidth(), getSceneRasterHeight(),
                                       "l2_flags.LAND AND l2_flags.PCD_18", Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_AERO_PRODUCTS,
                        ...
                        Mask.BandMathsType.create(BITMASKDEF_NAME_HIGH_GLINT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.HIGH_GLINT", new Color(204, 0, 204),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_MEDIUM_GLINT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.MEDIUM_GLINT",
                                       new Color(255, 51, 255), 0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_ICE_HAZE, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.ICE_HAZE", Color.yellow, 0.5F),

                        // the flags for atmospheric correction in blue
                        Mask.BandMathsType.create(BITMASKDEF_NAME_ABSOA_CONT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.ABSOA_CONT", new Color(0, 102, 255),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_ABSOA_DUST, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.ABSOA_DUST", new Color(0, 204, 255),
                                       0.5F),

                        // Case2 water flags in ochre
                        Mask.BandMathsType.create(BITMASKDEF_NAME_CASE2_S, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.CASE2_S", new Color(255, 255, 153),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_CASE2_ANOM, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.CASE2_ANOM", new Color(153, 153, 0),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_CASE2_Y, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.CASE2_Y", new Color(204, 204, 0), 0.5F),

                        // Land product flags
                        Mask.BandMathsType.create(BITMASKDEF_NAME_DARK_VEGETATION, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.DDV", new Color(0, 204, 0),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_TOAVI_BRIGHT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.TOAVI_BRIGHT",
                                       new Color(255, 204, 204), 0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_TOAVI_BAD, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.TOAVI_BAD", new Color(255, 153, 102),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_TOAVI_CSI, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.TOAVI_CSI", new Color(255, 153, 0),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_TOAVI_WS, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.TOAVI_WS", new Color(204, 102, 0),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_TOAVI_INVAL_REC, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.TOAVI_INVAL_REC",
                                       new Color(153, 51, 0), 0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_P_CONFIDENCE, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.P_CONFIDENCE",
                                       new Color(255, 204, 255), 0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_LOW_PRESSURE, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.LOW_PRESSURE",
                                       new Color(204, 204, 255), 0.5F),

                        // L1b copied flags in magenta
                        Mask.BandMathsType.create(BITMASKDEF_NAME_COSMETIC, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.COSMETIC", new Color(204, 153, 255),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_SUSPECT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.SUSPECT", new Color(204, 102, 255),
                                       0.5F),

                        // Product Confidence Flags
                        Mask.BandMathsType.create(BITMASKDEF_NAME_PCD_1_13, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.PCD_1_13", Color.red, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_PCD_14, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.PCD_14", Color.red, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_PCD_15, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.PCD_15", Color.red, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_PCD_16, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.PCD_16", Color.red, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_PCD_17, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.PCD_17", Color.red, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_PCD_18, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.PCD_18", Color.red, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_PCD_19, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.PCD_19", Color.red, 0.0F),
                };
                ...
                return new Mask[]{
                        ...
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_ALGAL2_TSM_YS,
                                       ...
                                       getSceneRasterWidth(), getSceneRasterHeight(),
                                       "l2_flags.WATER AND (l2_flags.PCD_16 OR l2_flags.PCD_17)", Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_PHOTOSYN_RAD,
                                       "Water pixels flagged for invalid PAR",
                                       getSceneRasterWidth(), getSceneRasterHeight(),
                                       "l2_flags.WATER AND l2_flags.PCD_18",
                                       Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_TOA_VEG,
                                       "Land pixels flagged for invalid toa_veg",
                                       getSceneRasterWidth(), getSceneRasterHeight(),
                                       "l2_flags.LAND AND l2_flags.PCD_15",
                                       Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_BOA_VEG,
                        ...
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_RECT_REFL,
                                       ...
                                       Color.black, 0.0F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_INVALID_SURF_PRESS,
                        ...
                        // the conditions that limitate algorithms in pink
                        Mask.BandMathsType.create(BITMASKDEF_NAME_LOW_SUN, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.LOW_SUN", new Color(153, 0, 153), 0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_HIGH_GLINT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.HIGH_GLINT", new Color(204, 0, 204),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_MEDIUM_GLINT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.MEDIUM_GLINT",
                                       new Color(255, 51, 255), 0.5F),
                        ...
                        // the flags for atmospheric correction in blue
                        Mask.BandMathsType.create(BITMASKDEF_NAME_LAND_AEROSOL_ON, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.LARS_ON",
                                       new Color(51, 51, 255),
                                       0.25F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_ABSOA_DUST, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.ABSOA_DUST", new Color(0, 204, 255),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_BPAC_ON, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.BPAC_ON", new Color(153, 255, 204),
                                       0.5F),
                        ...
                        // Land product flags
                        Mask.BandMathsType.create(BITMASKDEF_NAME_UNCERTAIN_AEROSOL_MODEL, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.OOADB",
                        ...
                        Mask.BandMathsType.create(BITMASKDEF_NAME_LOW_PRESSURE, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.LOW_PRESSURE",
                                       new Color(204, 204, 255), 0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_WHITE_SCATTERER, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.WHITE_SCATTERER",
                                       new Color(204, 204, 255), 0.5F),
                ...
                return new Mask[]{
                        ...
                        // Land product flags
                        Mask.BandMathsType.create(BITMASKDEF_NAME_SNOW_ICE, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.SNOW_ICE", new Color(255, 255, 153),
                                       0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_DENSE_DARK_VEG, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.DDV", new Color(51, 51, 255),
                                       0.25F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_UNCERTAIN_AEROSOL_MODEL, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.OOADB",
                                       new Color(0, 204, 0), 0.5F),
                        Mask.BandMathsType.create(BITMASKDEF_NAME_TOAVI_BRIGHT, null, getSceneRasterWidth(), getSceneRasterHeight(), "l2_flags.TOAVI_BRIGHT",
