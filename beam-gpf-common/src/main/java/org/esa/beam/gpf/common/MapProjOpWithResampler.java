    ...
    public void initialize() throws OperatorException {
        try {
            ...
            for (Band sourceBand : sourceProduct.getBands()) {
                ...
                // not matter
                Hints hints = new Hints(JAI.KEY_IMAGE_LAYOUT, createImageLayout(targetBand, tileSize));
                RenderedImage targetImage = Resampler2D.reproject(sourceCoverage, sourceImage, sourceCRS, targetCRS, gridGeometry, getInterpolation(), hints);
