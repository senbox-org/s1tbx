...
public class ProjectionDefinitionForm extends JPanel {
    ...
    public ProjectionDefinitionForm(Window parent) {
        this.parent = parent;

        this.datumList = ProjectionDefinitionForm.createDatumList();
        ...
        final List<OperationMethod> methodList = ProjectionDefinitionForm.createProjectionMethodList();
    ...
    public static void main(String[] args) {
        ...
        final ProjectionDefinitionForm definitionForm = new ProjectionDefinitionForm(frame);
