...
/**
 * The ReaderPlugIn for SkyWatch Format.
 */
public class STACProductReaderPlugIn implements ProductReaderPlugIn {
    ...
    public DecodeQualification getDecodeQualification(final Object input) {
        ...
        if (path != null) {
            try {
                ...
                if (realName.endsWith(STACProductConstants.METADATA_EXT)) {
    ...
    public ProductReader createReaderInstance() {
        return new STACProductReader(this);
    }
    ...
    public String[] getFormatNames() {
        return new String[] {STACProductConstants.FORMAT};
    }
    ...
    public String[] getDefaultFileExtensions() {
        return  new String[] {STACProductConstants.METADATA_EXT};
    }
    ...
    public String getDescription(final Locale locale) {
        return STACProductConstants.DESCRIPTION;
    }
    ...
    public static class FileFilter extends SnapFileFilter {
        ...
        public FileFilter() {
            super();
            setFormatName(STACProductConstants.FORMAT);
            setExtensions(new String[] {STACProductConstants.METADATA_EXT});
            setDescription(STACProductConstants.DESCRIPTION);
        }
        ...
        public boolean accept(final File file) {
            if (super.accept(file)) {
                ...
                return file.isDirectory() || filename.endsWith(STACProductConstants.METADATA_EXT);
            }
            return false;
        }
    }
