...
public final class CodeCompilerTest extends TestCase {
    ...
    public void testIt() throws Exception {
        ...
        CodeMapper.CodeMapping codeMapping = CodeMapper.mapCode(expression, name -> name);
        ...
        Class<?> aClass = new CodeCompiler(outputDir, classPath).compile("com.bc.ceres.jai.opimage.exprc", className, code);
