...
public class SampleConverterFactoryINT8Test {

    private static Band band;

    @Before
    public void beforeTest() {
        band = new Band("n", ProductData.TYPE_INT8, 1, 1);
    ...
    public void testToGeoPhysical_Unscaled() {
        ...
        assertEquals(127, sampleConverter.toGeoPhysical(127), 1.0e-6);
    ...
    public void testToGeoPhysical_Scaled() {
        ...
        assertEquals(127 * scalingFactor, sampleConverter.toGeoPhysical(127), 1.0e-6);
    ...
    public void testToRaw_Unscaled() {
        ...
        assertEquals(127, sampleConverter.toRaw(127), 1.0e-6);
        ...
        assertEquals(-128, sampleConverter.toRaw(-129), 1.0e-6);
        assertEquals(127, sampleConverter.toRaw(128), 1.0e-6);
    }
    ...
    public void testToRaw_Scaled() {
        ...
        assertEquals(127 / 1.1, sampleConverter.toRaw(127), 1.0e-6);
        ...
        // the converted shall be within the raw value range and no overflow shall appear
        assertEquals(-128, sampleConverter.toRaw(-129 * 1.1), 1.0e-6);
        assertEquals(127, sampleConverter.toRaw(128 * 1.1), 1.0e-6);
    }
