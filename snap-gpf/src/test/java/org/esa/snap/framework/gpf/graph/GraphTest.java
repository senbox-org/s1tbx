...
public class GraphTest extends TestCase {
    ...
    public void testOneNodeChain() {
        Graph graph = new Graph("chain1");
        Node node = new Node("node1", "org.esa.snap.framework.gpf.TestOps$Op1Spi");
        try {
            graph.addNode(node);
    ...
    public void testAddExistingNode() {
        Graph graph = new Graph("chain1");
        Node node1 = new Node("node1", "org.esa.snap.framework.gpf.TestOps$Op1Spi");
        Node node2 = new Node("node1", "org.esa.snap.framework.gpf.TestOps$Op2Spi");
        try {
            graph.addNode(node1);
            graph.addNode(node2);
