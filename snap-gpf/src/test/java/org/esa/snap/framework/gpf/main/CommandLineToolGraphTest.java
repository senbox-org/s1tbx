        ...
        public Graph readGraph(String filepath, Map<String, String> templateVariables) throws IOException, GraphException {
            ...
            if ("graph.xml".equals(filepath)) {
                xml = "<graph id=\"chain1\">" +
                        ...
                        "</header>\n" +
                        "<node id=\"node1\">" +
                        "  <operator>org.esa.snap.framework.gpf.TestOps$Op2$Spi</operator>\n" +
                        "  <sources>\n" +
                        ...
                        "</node>" +
                        "<node id=\"node2\">" +
                        "  <operator>org.esa.snap.framework.gpf.TestOps$Op3$Spi</operator>\n" +
                        "  <sources>\n" +
                        "    <input1 refid=\"node1\"/>\n" +
                ...
                xml = "<graph id=\"chain1\">" +
                        "<version>1.0</version>\n" +
                        "<node id=\"node1\">" +
                        "  <operator>org.esa.snap.framework.gpf.TestOps$OpImplementingOutput$Spi</operator>\n" +
                        "</node>" +
                        "</graph>";
            } else {
