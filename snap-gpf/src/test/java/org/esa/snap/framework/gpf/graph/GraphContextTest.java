...
public class GraphContextTest extends TestCase {
    ...
    public void testSourceToNodeResolving() throws GraphException {
        ...
        Node node1 = new Node("node1", "org.esa.snap.framework.gpf.TestOps$Op1$Spi");

        Node node2 = new Node("node2", "org.esa.snap.framework.gpf.TestOps$Op2$Spi");
        node2.addSource(new NodeSource("input", "node1"));

        Node node3 = new Node("node3", "org.esa.snap.framework.gpf.TestOps$Op3$Spi");
    ...
    public void testSpiCreation() throws GraphException {
        ...
        assertEquals("org.esa.snap.framework.gpf.TestOps$Op1", nodeContext.getOperator().getClass().getName());
    }
