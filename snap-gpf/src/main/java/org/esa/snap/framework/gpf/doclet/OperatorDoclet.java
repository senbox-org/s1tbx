...
// VM options: -Dceres.context=beam -Dbeam.mainClass=org.esa.snap.framework.gpf.doclet.OperatorDoclet
...
public class OperatorDoclet extends Doclet {
    ...
    public static void main(String[] args) {
        ...
        com.sun.tools.javadoc.Main.main(new String[]{
                ...
                "org.esa.snap.gpf.operators.standard",
                "org.esa.snap.gpf.operators.standard.reproject",
