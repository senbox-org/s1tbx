...
import org.esa.snap.framework.gpf.descriptor.AnnotationOperatorDescriptorBody;
 ...
 * {@link org.esa.snap.framework.gpf.GPF#getOperatorSpiRegistry() OperatorSpiRegistry} or
...
public abstract class OperatorSpi {
     ...
     * <p>
     * Shorthand for {@link org.esa.snap.framework.gpf.descriptor.OperatorDescriptor#getOperatorClass() getOperatorDescriptor().getOperatorClass()}.
     *
