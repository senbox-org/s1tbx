 ...
 */
public class FlagOrAggregator implements Downsampling {
    ...
    public Aggregator createDownsampler(RasterDataNode rasterDataNode, int dataBufferType) {
        return AggregatorFactory.createAggregator(AggregationType.FlagOr,dataBufferType);
    }

    public static class Spi extends DownsamplerSpi {
        public Spi() {
            super(FlagOrAggregator.class,"FlagOr");
        }
    }
}