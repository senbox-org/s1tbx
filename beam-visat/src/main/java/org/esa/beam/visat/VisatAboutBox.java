...
public class VisatAboutBox extends ModalDialog {
    ...
    private VisatAboutBox(JButton[] others) {
        super(VisatApp.getApp().getMainFrame(), "About VISAT", ModalDialog.ID_OK, others, null);    /*I18N*/
    ...
    private static String getVersionHtml() {
        final String pattern =
                ...
                "</html>";
        return MessageFormat.format(pattern, VisatApp.APP_VERSION); /*I18N*/
    }
