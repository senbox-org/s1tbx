...
public class ShapefileOutputterTest {
    ...
    public void testSingleShape() throws Exception {
        ...
        StatisticsOp.BandConfiguration bandConfiguration_1 = new StatisticsOp.BandConfiguration();
        ...
        bandConfiguration_1.percentile = 90;

        StatisticsOp.BandConfiguration bandConfiguration_2 = new StatisticsOp.BandConfiguration();
        bandConfiguration_2.sourceBandName = "algal_2";
        bandConfiguration_2.statisticsCalculatorDescriptor = new StatisticsCalculatorPercentile.Descriptor();
        bandConfiguration_2.percentile = 95;
        ...
        shapefileOutputter.addToOutput(bandConfiguration_1, "9_pixels.1", statistics);

        statistics.clear();
        statistics.put("p95", 0.195);
        shapefileOutputter.addToOutput(bandConfiguration_2, "9_pixels.1", statistics);
        ...
        assertNotNull(simpleFeature.getProperty("p90_lgl_2"));
        assertNotNull(simpleFeature.getProperty("p95_lgl_2"));

        assertEquals(0.1, (Double)simpleFeature.getProperty("p90_lgl_2").getValue(), 1E-6);
        assertEquals(0.195, (Double)simpleFeature.getProperty("p95_lgl_2").getValue(), 1E-6);
    }
    ...
    public void testThreeShapes() throws Exception {
        ...
        shapefileOutputter.addToOutput(bandConfiguration_1, "polygons.1", statistics);

        statistics.clear();
        statistics.put("p90", 2.90);
        shapefileOutputter.addToOutput(bandConfiguration_1, "polygons.2", statistics);

        statistics.clear();
        statistics.put("p90", 3.90);
        shapefileOutputter.addToOutput(bandConfiguration_1, "polygons.3", statistics);

        statistics.clear();
        statistics.put("p95", 1.95);
        shapefileOutputter.addToOutput(bandConfiguration_2, "polygons.1", statistics);

        statistics.clear();
        statistics.put("p95", 2.95);
        shapefileOutputter.addToOutput(bandConfiguration_2, "polygons.2", statistics);

        statistics.clear();
        statistics.put("p95", 3.95);
        shapefileOutputter.addToOutput(bandConfiguration_2, "polygons.3", statistics);
        ...
        for (SimpleFeature feature : shapefileOutputter.features) {
            if (feature.getID().contains("1")) {
                assertNotNull(feature.getProperty("p90_lgl_2"));
                assertNotNull(feature.getProperty("p95_lgl_2"));

                assertEquals(1.90, (Double) feature.getProperty("p90_lgl_2").getValue(), 1E-6);
                assertEquals(1.95, (Double) feature.getProperty("p95_lgl_2").getValue(), 1E-6);
            } else if(feature.getID().contains("2")) {
                assertNotNull(feature.getProperty("p90_lgl_2"));
                assertNotNull(feature.getProperty("p95_lgl_2"));

                assertEquals(2.90, (Double) feature.getProperty("p90_lgl_2").getValue(), 1E-6);
                assertEquals(2.95, (Double)feature.getProperty("p95_lgl_2").getValue(), 1E-6);
            }  else if(feature.getID().contains("3")) {
                assertNotNull(feature.getProperty("p90_lgl_2"));
                assertNotNull(feature.getProperty("p95_lgl_2"));

                assertEquals(3.90, (Double)feature.getProperty("p90_lgl_2").getValue(), 1E-6);
                assertEquals(3.95, (Double)feature.getProperty("p95_lgl_2").getValue(), 1E-6);
            }
        }
    }
