 ...
 * find files on step
 */
public class TestESAOrbitFileScraper {
    ...
    public static void setUpClass() {
        ...
        Assume.assumeTrue("Internet connection not available, skipping TestESAOrbitFileScraper", internetAvailable);
    }

    @Test
    public void testGetFileURLsPreciseOrbitFileS1A() {
        final OrbitFileScraper scraper = new OrbitFileScraper.ESA_S1(SentinelPODOrbitFile.PRECISE);
    ...
    public void testGetFileURLsRestituteOrbitFileS1A() {
        final OrbitFileScraper scraper = new OrbitFileScraper.ESA_S1(SentinelPODOrbitFile.RESTITUTED);
    ...
    public void testGetFileURLsRestituteOrbitFileS1B() {
        ...
        OrbitFileScraper.RemoteOrbitFile[] orbitFiles = scraper.getFileURLs("S1B", 2016, 7);
        assertEquals(590, orbitFiles.length);
    }
