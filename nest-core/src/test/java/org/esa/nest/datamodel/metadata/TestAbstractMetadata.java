...
public class TestAbstractMetadata {
    ...
    private static Product createProduct(final String type, final int w, final int h) {
        ...
        product.setStartTime(org.esa.nest.datamodel.AbstractMetadata.parseUTC("10-MAY-2008 20:30:46.890683"));
        product.setEndTime(org.esa.nest.datamodel.AbstractMetadata.parseUTC("10-MAY-2008 20:35:46.890683"));
