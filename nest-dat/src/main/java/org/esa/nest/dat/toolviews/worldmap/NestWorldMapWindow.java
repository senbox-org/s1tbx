 ...
 */
public class NestWorldMapWindow extends JDialog {

    private static final String DEFAUL_TTITLE = "World Map";

    private String helpId;
    private NestWorldMapPaneDataModel worldMapDataModel;
     ...
     */
    public NestWorldMapWindow(Frame owner, String title, String helpId) {
    ...
    private void createUI() {
        ...
        final NestWorldMapPane mapPane = new NestWorldMapPane(worldMapDataModel);
