...
public class ProductUtils {
     ...
     */
    public static Band copyBand(String bandName, Product sourceProduct, Product targetProduct) {
        Guardian.assertNotNull("sourceProduct", sourceProduct);
        Guardian.assertNotNull("targetProduct", targetProduct);
    ...
    /**
     * Adds bands of a source product to the given target product. This method is especially usefull if the target
     ...
     * @param addedBands         a mapping from source bands to a target bands, can be null
     */
    public static void copyBandsForGeomTransform(final Product sourceProduct,
        ...
        for (int i = 0; i < sourceProduct.getNumBands(); i++) {
            ...
            if (sourceBand.getGeoCoding() != null) {
                final int destWidth = targetProduct.getSceneRasterWidth();
                final int destHeight = targetProduct.getSceneRasterHeight();
        ...
        for (int i = 0; i < sourceProduct.getNumBands(); i++) {
            ...
            if (targetBand != null) {
                ...
                //
                final String sourceExpression = sourceBand.getValidPixelExpression();
                ...
                if (addedBands != null) {
                    addedBands.put(targetBand, sourceBand);
                }
            }
        }
    }
