...
public class TestMatrix {
    public static final String TEST_OUTPUT_PATH = "target/test-output";
    public static final String JAMA_TEST_MATRIX_PATH = TEST_OUTPUT_PATH + "/JamaTestMatrix.out";
    public static final String TMPMATRIX_SERIAL_PATH = TEST_OUTPUT_PATH + "/TMPMATRIX.serial";
...
**/
       print("\nTesting I/O methods...\n");
         ...
         fmt.setDecimalFormatSymbols(new DecimalFormatSymbols(Locale.US));
             ...
             PrintWriter FILE = new PrintWriter(new FileOutputStream(JAMA_TEST_MATRIX_PATH));
             A.print(FILE,fmt,10);
             FILE.close();
             R = Matrix.read(new BufferedReader(new FileReader(JAMA_TEST_MATRIX_PATH)));
       ...
       R = Matrix.random(A.getRowDimension(),A.getColumnDimension());
       String tmpname = TMPMATRIX_SERIAL_PATH;
       try {
