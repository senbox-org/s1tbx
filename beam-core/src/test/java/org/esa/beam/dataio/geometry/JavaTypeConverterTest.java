...
public class JavaTypeConverterTest extends TestCase {
    ...
    public void testSuccess() throws ConversionException {
        ...
        assertEquals(JavaTypeConverter.class, typeConverter.parse("org.esa.beam.dataio.geometry.JavaTypeConverter"));
        ...
        assertEquals("org.esa.beam.dataio.geometry.JavaTypeConverter", typeConverter.format(JavaTypeConverter.class));
    }
