...
public class VectorDataNodeReader2Test {
    ...
    private static final String INPUT = "# BEAM pin export table\n" +
                                        "#\n" +
    ...
    @Test
    public void testTrackFeatureType() throws Exception {

        CsvReader csvReader = new CsvReader(new StringReader(INPUT), new char[]{'\t'}, true, "#");
        SimpleFeatureType simpleFeatureType = new VectorDataNodeReader2(VectorDataNodeReader2.CsvType.TRACK, null, null).readFeatureType(csvReader);

        assertNotNull(simpleFeatureType);
        assertEquals(7, simpleFeatureType.getAttributeCount());
    ...
    @Test
    public void testTrackFeatureClasses() throws Exception {
        CsvReader csvReader = new CsvReader(new StringReader(INPUT), new char[]{'\t'}, true, "#");
        VectorDataNodeReader2 vectorDataNodeReader = new VectorDataNodeReader2(VectorDataNodeReader2.CsvType.TRACK, null, null);
