...
public class Nc4DataTypeWorkarounds {
    ...
    private Nc4DataTypeWorkarounds() {
    ...
    public static Nc4DataTypeWorkarounds getInstance() {
    ...
    private static class Holder {
        ...
        private static final Nc4DataTypeWorkarounds instance = new Nc4DataTypeWorkarounds();
    }
}
