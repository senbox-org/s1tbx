...
class NoaaTypes {
    ...
    static CompoundType radianceConversion =
            COMPOUND("RADIANCE_CONVERSION",
                    ...
                    META_MEMBER("CHANNEL_3B_CENTRAL_WAVENUMBER", INT, META().setScalingFactor(1E-2).setUnits(AvhrrConstants.UNIT_PER_CM)),
                    ...
                    META_MEMBER("CHANNEL_4_CENTRAL_WAVENUMBER", INT, META().setScalingFactor(1E-3).setUnits(AvhrrConstants.UNIT_PER_CM)),
                    ...
                    META_MEMBER("CHANNEL_5_CENTRAL_WAVENUMBER", INT, META().setScalingFactor(1E-3).setUnits(AvhrrConstants.UNIT_PER_CM)),
    ...
    static CompoundType navigation =
            COMPOUND("NAVIGATION",
                    ...
                    META_MEMBER("NADIR_EARTH_LOCATION_TOLERANCE", USHORT, META().setScalingFactor(1E-1).setUnits(AvhrrConstants.UNIT_KM)),
                    MEMBER("EARTH_LOCATION_BIT_FIELD", USHORT),
                    FILL_MEMBER(2),
                    META_MEMBER("CONSTANT_ROLL_ATTITUDE_ERROR", SHORT, META().setScalingFactor(1E-3).setUnits(AvhrrConstants.UNIT_DEG)),
                    META_MEMBER("CONSTANT_PITCH_ATTITUDE_ERROR", SHORT, META().setScalingFactor(1E-3).setUnits(AvhrrConstants.UNIT_DEG)),
                    META_MEMBER("CONSTANT_YAW_ATTITUDE_ERROR", SHORT, META().setScalingFactor(1E-3).setUnits(AvhrrConstants.UNIT_DEG)),
                    META_MEMBER("EPOCH_YEAR_FOR_ORBIT_VECTOR", USHORT, META().setUnits(AvhrrConstants.UNIT_YEARS)),
                    META_MEMBER("DAY_OF_EPOCH_YEAR_FOR_ORBIT_VECTOR", USHORT, META().setUnits(AvhrrConstants.UNIT_DAYS)),
                    META_MEMBER("EPOCH_UTC_TIME_OF_DAY_FOR_ORBIT_VECTOR", UINT, META().setUnits(AvhrrConstants.UNIT_MS)),

                    META_MEMBER("SEMI_MAJOR_AXIS", INT, META().setScalingFactor(1E-5).setUnits(AvhrrConstants.UNIT_KM)),
                    META_MEMBER("ECCENTRICITY", INT, META().setScalingFactor(1E-8)),
                    META_MEMBER("INCLINATION", INT, META().setScalingFactor(1E-5).setUnits(AvhrrConstants.UNIT_DEG)),
                    META_MEMBER("ARGUMENT_OF_PERIGEE", INT, META().setScalingFactor(1E-5).setUnits(AvhrrConstants.UNIT_DEG)),
                    META_MEMBER("RIGHT_ASCENSION_OF_THE_ASCENDING_NODE", INT, META().setScalingFactor(1E-5).setUnits(AvhrrConstants.UNIT_DEG)),
                    META_MEMBER("MEAN_ANOMALY", INT, META().setScalingFactor(1E-5).setUnits(AvhrrConstants.UNIT_DEG)),

                    META_MEMBER("POSITION_VECTOR_X_COMPONENT", INT, META().setScalingFactor(1E-5).setUnits(AvhrrConstants.UNIT_KM)),
                    META_MEMBER("POSITION_VECTOR_Y_COMPONENT", INT, META().setScalingFactor(1E-5).setUnits(AvhrrConstants.UNIT_KM)),
                    META_MEMBER("POSITION_VECTOR_Z_COMPONENT", INT, META().setScalingFactor(1E-5).setUnits(AvhrrConstants.UNIT_KM)),
                    META_MEMBER("VELOCITY_VECTOR_X_DOT_COMPONENT", INT, META().setScalingFactor(1E-8).setUnits(AvhrrConstants.UNIT_KM)),
                    META_MEMBER("VELOCITY_VECTOR_Y_DOT_COMPONENT", INT, META().setScalingFactor(1E-8).setUnits(AvhrrConstants.UNIT_KM)),
                    META_MEMBER("VELOCITY_VECTOR_Z_DOT_COMPONENT", INT, META().setScalingFactor(1E-8).setUnits(AvhrrConstants.UNIT_KM)),
    ...
    private static CompoundMember FILL_MEMBER(int bytes) {
    ...
    private static CompoundType getDataRecordType(ProductFormat productFormat) {
        ...
        return COMPOUND("DataRecord",
                ...
                FILL_MEMBER(208),
                // AVHRR SENSOR DATA
                MEMBER("AVHRR_SENSOR_DATA", SEQUENCE(productFormat.getElementType(), productFormat.getElementCount())),
                FILL_MEMBER(8),
                // DIGITAL B TELEMETRY
                FILL_MEMBER(16),
