...
/**
 * The ProductGroup writer
 */
public class ProductGroupWriterPlugIn implements ProductWriterPlugIn {

    public final static String FORMAT_NAME = ProductGroupReaderPlugIn.FORMAT_NAME;
    private final SnapFileFilter fileFilter = new SnapFileFilter(getFormatNames()[0], getDefaultFileExtensions(), getDescription(null));

    /**
     * Constructs a new ProductGroup product writer plug-in instance.
     */
    public ProductGroupWriterPlugIn() {
    }
    ...
    public String getDescription(Locale locale) {
        return "ProductGroup writer";
    }

    /**
     * Creates an instance of the actual ProductGroup product writer class.
     *
     * @return a new instance of the <code>EnviProductWriter</code> class
     */
    public ProductWriter createWriterInstance() {
        return new ProductGroupWriter(this);
    }
