...
public abstract class ObjectStorageFileSystemProvider extends FileSystemProvider {
    ...
    public Path getPath(URI uri) {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Unable to create URI for VFS with scheme: " + getScheme() + ". Details: " + ex.getMessage());
        ...
        String pathName = fileSystem.getSeparator() + ssp;
    ...
    public void createDirectory(Path dir, FileAttribute<?>[] attrs) throws IOException {
        if (dir == null) {
            throw new IOException("Dir is missing.");
        }
    ...
    public void delete(Path path) throws IOException {
        if (path == null) {
            throw new IOException(PATH_NULL_ERROR_MESSAGE);
        }
        throw new UnsupportedOperationException();
    }
    ...
    public void copy(Path source, Path target, CopyOption... options) throws IOException {
        if (source == null) {
            throw new IOException(SOURCE_NULL_ERROR_MESSAGE);
        }
        throw new UnsupportedOperationException();
    }
    ...
    public void move(Path source, Path target, CopyOption... options) throws IOException {
        ...
        if (target == null) {
            throw new IOException("Target is missing.");
        }
        throw new UnsupportedOperationException();
    }
