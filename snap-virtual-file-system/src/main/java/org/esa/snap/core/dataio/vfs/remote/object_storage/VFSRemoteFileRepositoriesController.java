...
public final class VFSRemoteFileRepositoriesController {
     ...
     * @return The property
     * @see org.esa.snap.core.dataio.vfs.remote.model.Property
     */
     ...
     * @see org.esa.snap.core.dataio.vfs.remote.model.VFSRemoteFileRepository
     */
    ...
    public static void installVFSRemoteFileRepository(VFSRemoteFileRepository vfsRemoteFileRepository) throws IOException {
        ...
        VFSRemoteFileRepositoriesController vfsRemoteFileRepositoriesController = new VFSRemoteFileRepositoriesController();
        try {
            if (new RepositoryNameValidator().isValid(vfsRemoteFileRepository.getName()) && vfsRemoteFileRepositoriesController.isUniqueRemoteRepositoryName(vfsRemoteFileRepository.getName()) && new RepositorySchemaValidator().isValid(vfsRemoteFileRepository.getSchema()) && new RepositoryAddressValidator().isValid(vfsRemoteFileRepository.getAddress())) {
                ...
                vfsRemoteFileRepositoriesController.setRemoteRepositorySchema(remoteRepositoryId, vfsRemoteFileRepository.getSchema());
