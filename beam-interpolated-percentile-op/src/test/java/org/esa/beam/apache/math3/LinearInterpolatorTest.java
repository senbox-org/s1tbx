...
public class LinearInterpolatorTest {
    ...
    public void testInterpolationOfStraightLine() {
        ...
        //execution
        final PolynomialSplineFunction function = linearInterpolator.interpolate(x, y);
    ...
    private void assertUnknownValuesAreGuessedCorrectly(double[] y, PolynomialSplineFunction function) {
        double[] testValues = new double[]{1d, 3d, 5d, 7d};
        assertUnknownValuesAreGuessedCorrectly(y, function, testValues);
    }

    private void assertUnknownValuesAreGuessedCorrectly(double[] y, PolynomialSplineFunction function, double[] testValues) {
