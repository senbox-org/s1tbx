    ...
    stages {
        stage('Package') {
            ...
            steps {
                ...
                sh 'mvn -Duser.home=/var/maven -Dsnap.userdir=/home/snap clean package install -U -Dsnap.reader.tests.data.dir=/data/ssd/testData/s1tbx/ -Dsnap.reader.tests.execute=false -DskipTests=false'
