...
public class LayerTreeModel2 extends DefaultTreeModel {

    public LayerTreeModel2(final Layer layer) {
    ...
    private class LayerListener extends AbstractLayerListener {
        ...
        public void handleLayersAdded(Layer parentLayer, Layer[] childLayers) {
            final DefaultMutableTreeNode rootNode = (DefaultMutableTreeNode) LayerTreeModel2.this.getRoot();
            //noinspection unchecked
            ...
            for (final Layer addedLayer : addedLayers) {
                ...
                for (int i = 0; i < childLayerList.size(); ++i) {
                    if (childLayerList.get(i) == addedLayer) {
                        LayerTreeModel2.this.insertNodeInto(new DefaultMutableTreeNode(addedLayer), parentNode, i);
                        break;
                    }
                }
            }
            ...
            for (final Layer childLayer : childLayers) {
                ...
                while (childNodeEnumeration.hasMoreElements()) {
                    ...
                    if (childNode.getUserObject() == childLayer) {
                        LayerTreeModel2.this.removeNodeFromParent(childNode);
                        break;
                    }
                }
            }
