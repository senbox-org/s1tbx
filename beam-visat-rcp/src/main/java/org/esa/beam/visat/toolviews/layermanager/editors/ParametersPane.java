...
import org.esa.beam.visat.toolviews.imageinfo.ColorComboBoxAdapter;
    ...
    public JPanel createPanel() {
        ...
        for (ValueModel model : models) {
            ...
            if (isNumericType(type)) {
                ...
                JTextField textField = new JTextField();
                final Binding binding = bindingContext.bind(propertyName, textField);
                ...
                bindingContext.bind(propertyName, new ColorComboBoxAdapter(colorComboBox));
                editorComponent = colorComboBox;
            }else {
                ValueSet valueSet = model.getDescriptor().getValueSet();
                if (valueSet != null) {
                    if (type.isArray()) {
                        final JList list = new JList();
                        bindingContext.bind(propertyName, list, true);
                        editorComponent = new JScrollPane(list);
                    } else {
                        JComboBox comboBox = new JComboBox();
                        bindingContext.bind(propertyName, comboBox);
            ...
            editorComponent.setName(propertyName);
