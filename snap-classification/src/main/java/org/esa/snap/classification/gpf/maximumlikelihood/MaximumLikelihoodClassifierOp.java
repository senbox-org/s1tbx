...
@OperatorMetadata(alias = "Maximum-Likelihood-Classifier",
...
public class MaximumLikelihoodClassifierOp extends Operator {

    public final static String CLASSIFIER_TYPE = "MaximumLikelihood";
    private final static String PRODUCT_SUFFIX = "_MLClass";
    ...
    public void initialize() throws OperatorException {
        try {
            ...
            classifier = new MaximumLikelihoodClassifier(
