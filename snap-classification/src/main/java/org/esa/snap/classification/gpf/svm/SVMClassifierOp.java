...
@OperatorMetadata(alias = "SVM-Classifier",
        category = "Raster/Classification/Supervised Classification",
        authors = "Cecilia Wong, Luis Veci",
        copyright = "Copyright (C) 2016 by Array Systems Computing Inc.",
        description = "Support vector machine classifier")
public class SVMClassifierOp extends Operator {

    public final static String CLASSIFIER_TYPE = "SVM";
    private final static String PRODUCT_SUFFIX = "_SVMClass";
