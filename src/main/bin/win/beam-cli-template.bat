...
"%BEAM4_HOME%\jre\bin\java.exe" ^
    ...
    "-Dncsa.hdf.hdflib.HDFLibrary.hdflib=%BEAM4_HOME%\modules\lib-hdf-${hdf.version}\lib\win\jhdf.dll" ^
    "-Dncsa.hdf.hdf5lib.H5.hdf5lib=%BEAM4_HOME%\modules\lib-hdf-${hdf.version}\lib\win\jhdf5.dll" ^
