...
public class DefaultImageLayerModel implements ImageLayerModel {
    public static final DefaultImageLayerModel NULL = createNullImage();
    ...
    public DefaultImageLayerModel(LevelImageSource levelImageSource, AffineTransform imageToModelTransform, Rectangle2D modelBounds) {
    ...
    private static DefaultImageLayerModel createNullImage() {
        return new DefaultImageLayerModel(new DefaultLevelImageSource(new BufferedImage(1, 1, BufferedImage.TYPE_BYTE_GRAY)), new AffineTransform(), new Rectangle(1, 1));
    }
