...
public class SGD extends RandomizableClassifier
     ...
     *
     * @param m true if global replacement of missing values is to be turned
     * off.
     */
    ...
    public String toString() {
        ...
        for (int i = 0; i < m_weights.length - 1; i++) {
            if (i != m_data.classIndex()) {
                ...
                buff.append(Utils.doubleToString(m_weights[i], 12, 4)).append(" ").append((m_normalize != null) ? "(normalized) " : "").append(m_data.attribute(i).name()).append("\n");
