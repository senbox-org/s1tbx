...
BandDescriptor = jpy.get_type('org.esa.snap.core.gpf.standard.BandMathsOp$BandDescriptor')
...
targetBands = jpy.array('org.esa.snap.core.gpf.standard.BandMathsOp$BandDescriptor', 2)
