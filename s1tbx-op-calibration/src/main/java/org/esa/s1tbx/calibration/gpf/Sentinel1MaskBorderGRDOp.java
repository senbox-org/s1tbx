 ...
 */
@OperatorMetadata(alias = "Sentinel1-Mask-Border-GRD",
        category = "Radar/Radiometric",
        authors = "Jun Lu, Luis Veci",
        copyright = "Copyright (C) 2014 by Array Systems Computing Inc.",
        description = "Mask no-value pixels for GRD product")
public final class Sentinel1MaskBorderGRDOp extends Operator {
     ...
     */
    public Sentinel1MaskBorderGRDOp() {
    }
    ...
    public static class Spi extends OperatorSpi {
        public Spi() {
            super(Sentinel1MaskBorderGRDOp.class);
        }
    }
}
