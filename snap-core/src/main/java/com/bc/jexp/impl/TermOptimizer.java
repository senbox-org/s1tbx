 ...
 * term's structure in an unwanted way. For example, the term {@code sqrt(sqr(t))} can be simplified to {@code abs(t)}
 ...
 * the {@link TermSimplifier} is {@code sqrt(sqr(t)) --> abs(t)}.
