...
public abstract class AbstractProductReader implements ProductReader {
     ...
     * @see #readBandRasterDataImpl(int, int, int, int, int, int, org.esa.snap.framework.datamodel.Band, int, int, int, int, org.esa.snap.framework.datamodel.ProductData, com.bc.ceres.core.ProgressMonitor)
     * @see #getSubsetDef()
     * @see ProductReader#readBandRasterData(org.esa.snap.framework.datamodel.Band, int, int, int, int, org.esa.snap.framework.datamodel.ProductData, com.bc.ceres.core.ProgressMonitor)
     ...
     * @return <code>true</code> if so
     * @see org.esa.snap.framework.dataio.ProductReaderPlugIn#getInputTypes()
     */
