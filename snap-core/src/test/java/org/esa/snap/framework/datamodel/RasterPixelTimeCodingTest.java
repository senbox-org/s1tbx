 ...
 */
public class RasterPixelTimeCodingTest {
    ...
    public void testCSVProductReaderBehavior() throws Exception {
        ...
        TimeCoding timeCoding = new RasterPixelTimeCoding(onlyThreeDoubles, 2, 2);
    ...
    public void testImplementsTimeCoding() {
        TimeCoding timeCoding = new RasterPixelTimeCoding(new double[]{3.0, 4.0, 5.0}, 2, 2);
    ...
    public void testCornerOn2x2Coding() {
        TimeCoding timeCoding = new RasterPixelTimeCoding(new double[]{3, 6, 2, 4}, 2, 2);
