...
public class GaussianUncertaintyPropagatorTest extends UncertaintyPropagatorTest {
    ...
    public void testGaussianUncertaintyPropagator() throws Exception {
        ...
        assertEquals("sqrt(sqr(B1_unc))", uncert("B1 - B3"));
        assertEquals("sqrt(sqr(B1_unc))", uncert("B3 - B1"));
        assertEquals("sqrt(sqr(B1_unc) + sqr(B2_unc))", uncert("B1 - B2 - B3"));
        assertEquals("sqrt(sqr(B1_unc) + sqr(B2_unc))", uncert("B2 - B3 - B1"));

        assertEquals("sqrt(sqr(B1 * B2_unc) + sqr(B1_unc * B2))", uncert("B1 * B2"));
        assertEquals("sqrt(sqr(B1_unc * B3))", uncert("B1 * B3"));
        ...
        assertEquals("sqrt(sqr(B1_unc * B3 / sqr(B3)))", uncert("B1 / B3"));
        assertEquals("sqrt(sqr(B1_unc * -B3 / sqr(B1)))", uncert("B3 / B1"));
        ...
        assertEquals("sqrt(sqr(B1_unc * cos(B1)))", uncert("sin(B1)"));

        assertEquals("0.0", uncert("cos(B3)"));
        assertEquals("sqrt(sqr(B1_unc * -sin(B1)))", uncert("cos(B1)"));

        assertEquals("0.0", uncert("tan(B3)"));
        assertEquals("sqrt(sqr(B1_unc / sqr(cos(B1))))", uncert("tan(B1)"));

        assertEquals("0.0", uncert("sqrt(B3)"));
        assertEquals("sqrt(sqr(B2_unc / (2.0 * sqrt(B2))))", uncert("sqrt(B2)"));
