...
public class PlacemarkDescriptorRegistryTest {
    ...
    public void testThatRegistryHostsKnownPlacemarkDescriptors() throws Exception {
        ...
        assertNotNull(registry.getPlacemarkDescriptor("org.esa.snap.framework.datamodel.PinDescriptor"));
        assertNotNull(registry.getPlacemarkDescriptor("org.esa.snap.framework.datamodel.GcpDescriptor"));
        assertNotNull(registry.getPlacemarkDescriptor("org.esa.snap.framework.datamodel.GeometryDescriptor"));
        assertNull(registry.getPlacemarkDescriptor("org.esa.snap.framework.datamodel.GenericPlacemarkDescriptor"));
        ...
        assertTrue("expected placemarkDescriptors.length >= 3, but was " + descriptors.size(),
                   descriptors.size() >= 3);
        assertTrue(descriptors.contains(registry.getPlacemarkDescriptor("org.esa.snap.framework.datamodel.PinDescriptor")));
        assertTrue(descriptors.contains(registry.getPlacemarkDescriptor("org.esa.snap.framework.datamodel.GcpDescriptor")));
        assertTrue(descriptors.contains(registry.getPlacemarkDescriptor("org.esa.snap.framework.datamodel.GeometryDescriptor")));
        assertFalse(descriptors.contains(registry.getPlacemarkDescriptor("org.esa.snap.framework.datamodel.GenericPlacemarkDescriptor")));
    }

    @Test
    public void testThatPlacemarkDescriptorIsFoundForPinFeatureType() throws Exception {
        testThatPlacemarkDescriptorIsFound("org.esa.snap.Pin", "org.esa.snap.framework.datamodel.PinDescriptor", 3);
    }

    @Test
    public void testThatPlacemarkDescriptorIsFoundForGcpFeatureType() throws Exception {
        testThatPlacemarkDescriptorIsFound("org.esa.snap.GroundControlPoint", "org.esa.snap.framework.datamodel.GcpDescriptor", 3);
    }

    @Test
    public void testThatPlacemarkDescriptorIsFoundForGeometryFeatureType() throws Exception {
        testThatPlacemarkDescriptorIsFound("org.esa.snap.Geometry", "org.esa.snap.framework.datamodel.GeometryDescriptor", 2);
    }
