...
public class GcpDescriptorTest {
    ...
    public void testSetUserData() throws Exception {
        ...
        assertEquals("org.esa.snap.framework.datamodel.GcpDescriptor", ft1.getUserData().get("placemarkDescriptor"));
        ...
        assertEquals("org.esa.snap.framework.datamodel.GcpDescriptor", ft2.getUserData().get("placemarkDescriptor"));
