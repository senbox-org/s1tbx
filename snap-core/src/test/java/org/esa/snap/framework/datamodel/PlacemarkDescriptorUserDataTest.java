...
public class PlacemarkDescriptorUserDataTest {
    ...
    public void testSetUserData() throws Exception {
        ...
        testSetUserDataOf(new PinDescriptor(), "org.esa.snap.framework.datamodel.PinDescriptor");
        testSetUserDataOf(new GcpDescriptor(), "org.esa.snap.framework.datamodel.GcpDescriptor");
        testSetUserDataOf(new TrackPointDescriptor(), "org.esa.snap.framework.datamodel.TrackPointDescriptor");
        testSetUserDataOf(new GeometryDescriptor(), "org.esa.snap.framework.datamodel.GeometryDescriptor");
        ...
        testSetUserDataOf(new GenericPlacemarkDescriptor(featureType), "org.esa.snap.framework.datamodel.GenericPlacemarkDescriptor");
    }
