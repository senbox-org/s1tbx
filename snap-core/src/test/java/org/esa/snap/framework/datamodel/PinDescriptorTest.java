...
public class PinDescriptorTest {
    ...
    public void testSetUserData() throws Exception {
        ...
        assertEquals("org.esa.snap.framework.datamodel.PinDescriptor", ft1.getUserData().get("placemarkDescriptor"));
        ...
        assertEquals("org.esa.snap.framework.datamodel.PinDescriptor", ft2.getUserData().get("placemarkDescriptor"));
