...
public class SceneRasterTransformUtilsTest {
    ...
    public void setUp() throws NoninvertibleTransformException {
        ...
        final MathTransform2D band2TransformForward = new AffineTransform2D(band2Transform);
        final MathTransform2D band2TransformInverse = new AffineTransform2D(band2Transform.createInverse());
        ...
        final MathTransform2D band3TransformForward = new AffineTransform2D(band3Transform);
        final MathTransform2D band3TransformInverse = new AffineTransform2D(band3Transform.createInverse());
    ...
    @Test
    public void testTransformFromToRasterGrid_PixelPos() throws TransformException, SceneRasterTransformException, NoninvertibleTransformException {
        ...
        final MathTransform2D band4TransformForward = new AffineTransform2D(band4Transform);
        final MathTransform2D band4TransformInverse = new AffineTransform2D(band4Transform.createInverse());
