    ...
    private static void compareBands(Product expProduct, Product currentProduct, StringBuffer diff) {
        ...
        for (int i = 0; i < expBands.length; i++) {
            ...
            if (expBand.getRasterWidth() != currentBand.getRasterWidth()) {
                diff.append(
                        "SceneRasterWidth of Band " + i + " expected <" + expBand.getRasterWidth() + "> but was <" + currentBand.getRasterWidth() + ">\r\n");
            }
            if (expBand.getRasterHeight() != currentBand.getRasterHeight()) {
                diff.append(
                        "SceneRasterHeight of Band " + i + " expected <" + expBand.getRasterHeight() + "> but was <" + currentBand.getRasterHeight() + ">\r\n");
            }
