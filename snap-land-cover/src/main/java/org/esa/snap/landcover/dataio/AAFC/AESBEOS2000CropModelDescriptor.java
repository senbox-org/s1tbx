...
public class AESBEOS2000CropModelDescriptor extends AbstractLandCoverModelDescriptor {
    ...
    private static final File[] fileList = new File[]{
            ...
            new File(INSTALL_DIR, "LCV_UTM12_AAFC_30M_2000_v12.zip"),
            new File(INSTALL_DIR, "LCV_UTM13_AAFC_30M_2000_v12.zip"),
            new File(INSTALL_DIR, "LCV_UTM14_AAFC_30M_2000_v12.zip"),
            ...
            new File(INSTALL_DIR, "LCV_UTM19_AAFC_30M_2000_v12.zip"),
            new File(INSTALL_DIR, "LCV_UTM20_AAFC_30M_2000_v12.zip"),
            new File(INSTALL_DIR, "LCV_UTM21_AAFC_30M_2000_v12.zip"),
            new File(INSTALL_DIR, "LCV_UTM22_AAFC_30M_2000_v12.zip"),
    };

    public AESBEOS2000CropModelDescriptor() {
        remotePath = "http://nest.s3.amazonaws.com/data/LandCover/AAFC/AESB_EOS_Crop_2000/";
        name = NAME;
