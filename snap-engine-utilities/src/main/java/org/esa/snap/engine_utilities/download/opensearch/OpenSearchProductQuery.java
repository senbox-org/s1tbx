 ...
 */
public class OpenSearchProductQuery implements ProductQueryInterface {

    private static OpenSearchProductQuery instance;
    ...
    private OpenSearchProductQuery() {

    }

    public static OpenSearchProductQuery instance() {
        if(instance == null) {
            instance = new OpenSearchProductQuery();
        }
        return instance;
    }
    ...
    public void query(final DBQuery dbQuery) {
